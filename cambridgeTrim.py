# cambridgeTrim
# This script trims the first 40 records and the last record off a Cambridge data set. It process all data sets in a 
# directory. It can be pretty slow if there are a lot of directories.
...
for dataSet in dataSetList:
    ...
    if len(dataSet) > 2:
       ...
       try:
          ...
          print('The trimmed version of this data set failed to load.')
...
# total_bytes = len(data)
# data[:total_bytes-record_size_in_bytes].tofile('100_CH1_trimmed.continuous')